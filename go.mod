module github.com/JAtula/vault-handler
...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v0.0.0-20190221092316-09232227da30 // indirect
	...
	k8s.io/api v0.0.0-20190221013315-7644c54216e9 // indirect
	k8s.io/apimachinery v0.0.0-20190220193147-198163bfa79a // indirect
